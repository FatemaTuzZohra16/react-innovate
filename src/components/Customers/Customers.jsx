                ...
                >
                    ...
                    <div className='md:flex justify-between'>
                        <div className='my-[85px] md:mr-[70px] mr-0 text-center md:text-left'>
                            <h3 className='w-auto md:w-[554px] font-chivo font-bold md:text-[44px] text-[30px] text-white pt-10 md:pt-0'>Trusted by 35,000+ happy customers.</h3>
                            <div className='flex justify-between pb-8 md:pb-0'>
                                {
                                    customerData.map((item) => (
                                        <div className='w-auto md:w-[176px] md:gap-10 gap-4'>
                                            <h4 className='font-chivo font-black md:text-[44px] text-[30px] leading-[54px] text-white mt-[64px] mb-3'>{item.title}</h4>
                                            <p className='font-sans font-medium md:text-lg text-[16px] md:leading-8 leading-[22px] text-white'>{item.description}</p>
                                        </div>
                                 ))
                                }
                            </div>
