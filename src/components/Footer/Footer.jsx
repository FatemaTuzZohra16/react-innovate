...
export const Footer = () => {
    return (
        <section className='mt-[309px] bg-[#F7F7FC]'>
            <Container>
               <div>
               <div className='relative pb-[30px]'>
                    <div className='absolute top-[-150px] w-full' style={{
                       ...
                       <div className='flex justify-between items-center px-[102px] py-[100px]'>
                            <div className='text-white'>
                                <h2 className='w-[577px] font-chivo font-bold text-[46px] leading-[58px]'>Don’t find the answer? contact us for any query.</h2>
                            </div>
                            <div>
                                <a className='font-sans font-medium text-lg leading-5 text-headingColor bg-secondary py-5 px-[48px] rounded-[6px]' href="#">Contact Us</a>
                            </div>
                        </div>                     
                    </div>
                    <div className='main pt-[291px] pb-[86px] flex justify-between'>
                        <div className="w-[263px] logo">
                            ...
                            <div className="icons w-[185px] flex gap-[6px]">
